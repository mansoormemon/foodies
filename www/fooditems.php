    ...
    <div class="parent container-fluid section p-4">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                ?>
                    <div class="card m-5 p-0" style="width: 24rem;" id="<?php echo $cardRow['FOOD_ITEM_ID']; ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group flex-nowrap">
                                <input type="number" min="1" max="9" value="1" class="form-control foodItemCounterBox">
                                <button type="button" onclick="CartAdd(<?php echo $cardRow['FOOD_ITEM_ID']; ?>)" class="btn btn-sm btn-outline-primary input-group-text">
                                    Add to cart
                                </button>
                            </div>
                        </div>
